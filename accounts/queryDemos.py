...
# Возвращает все объекты из таблицы в виде списка
customers = Customer.objects.all()

#(2)Returns first customer in table
# Возвращает первый объект из таблицы
firstCustomer = Customer.objects.first()

#(3)Returns last customer in table
# Возвращает последний объект из таблицы
lastCustomer = Customer.objects.last()

#(4)Returns single customer by name
# Возвращает объект по совпадению из таблицы(фильтр по имени)
customerByName = Customer.objects.get(name='Peter Piper')

#***(5)Returns single customer by name
# Возвращает объект по совпадению из таблицы(фильтр по id - порядковый номер в таблице)
